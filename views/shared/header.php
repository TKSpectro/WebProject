<header>
    ...
    <ul class="icons">
        ...
        <li>
            <a href="index.php?a=shoppingCart"><img id="Warenkorb" src="assets/images/shopping-cart.png"
                                                    alt="Warenkorb"></a>
        </li>
        <?php if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] === true) : ?>
            <li>
                <a href="index.php?a=account"><img src="assets/images/Account_verwaltung.png" alt="Account"></a>
            </li>
        ...
        <?php else : ?>
            <li>
                <a href="index.php?a=login"><img src="assets/images/Account_verwaltung.png" alt="Account"></a>
            </li>
        <?php endif; ?>
    </ul>
    <ul>
