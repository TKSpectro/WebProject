...
<nav>
    <ul class="navbar ">
        ...
        <ul class="subnav-content">
            ...
            {?>
                <li class="topNavList"><a class="topNavBoy" href="index.php?c=product&a=products&type=Jungs-Toys&cat=<?= $Cat['catID'] ?>">
                        <?= $Cat['descrip']; ?></a></li>
            <? } ?>
        </ul></div>
        ...
        <ul class="subnav-content">
            ...
            href="index.php?c=product&a=products&type=Mädchen-Toys&cat=<?= $Cat['catID'] ?>"><?= $Cat['descrip']; ?></a></li>
                <? } ?>
            </ul></div>
        </li>
        <li class="subnav">
